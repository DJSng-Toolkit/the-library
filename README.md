...
| [Legacy Fabric Mod Compatibility List](https://legacyfabric.net/mods.html)  | Legacy Fabric | General list for mod compatibility for Legacy Fabric supported versions. |
